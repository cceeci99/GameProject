Ονοματεπώνυμα:
  ...
  Στο directory Creatures/Monsters περιλαμβάνονται τα απαραίτητα αρχεία για την υλοποιηση των τεράτων.
    ...
    9) Δημιουργία Μαχης:
      ...
      Η κλάση Fight υλοποιεί την μάχη οπως περιγράφεται. Σε κάθε γύρο της μάχης ο χρήστης εχει την δυνατότητα να εμφανίσει τα στατιστικά όλων των ατόμων, έπειτα
