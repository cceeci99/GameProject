Ονοματεπώνυμα:
  ...
  Στο directory Creatures/Heroes περιλαμβάνονται τα απαραίτητα αρχεια για τις κλάσεις των ηρώων.
     ...
     -Κατα την checkInventory εκτυπώνονται τα items που διαθέτει ο καθε ήρωας της ομάδας και αφήνεται στον χρήστη η επιλογή
      ...
      -Κατα την κλήση της castSpell() εκτυπώνονται τα διαθέσιμα ξόρκια του ήρωα και αφήνεται στον χρήστη η επιλογή κάποιου ξορκιού.
  ...
  Στο directory Creatures/Monsters περιλαμβάνονται τα απαραίτητα αρχεία για την υλοποιηση των τεράτων.
    ...
    8) Δημιουργία παιχνιδιου:
       ...
       επίσης φτιάχνεται ενα MarketPlace το οποίο γεμίζει με καποια αντικείμενα και ξόρκια.
       Θεωρούμε οτι η αγορά ειναι κοινή σε ολο το map.
       ...
       Ο χρήσης μετακινεί την ομάδα του μεσω των πλήκτρων (w,a,s,d), μπορεί να ελέγξει την ομάδα του και τα στατιστικα των ηρώων μεσω του πλήκτρου c,
    ...
    9) Δημιουργία Μαχης:
      ...
      Η κλάση Fight περιέχει την υλοποίηση της μάχης. Σε κάθε γύρο της μάχης ο χρήστης εχει την δυνατότητα να εμφανίσει τα στατιστικά όλων των ατόμων, έπειτα
      μπορεί να επιλέξει κατάλληλο εξοπλισμό και στην συνέχεια μπορεί να κάνει κανονικη επίθεση με το πλήκτρο o,  να χρησιμοποιήσει κάποιο ξόρκι με το πλήκτρο l
      ή να χρησιμοποιήσει καποιο φιλτρο με το πλήκτρο p. Η επίθεση γίνεται σε τυχαίο αντίπαλο (γίνεται αυτόματα).
      Αντίστοιχα και το κάθε τέρας κανει επίθεση σε τυχαία επιλεγμένο ήρωα.
